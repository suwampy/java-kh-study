...
if (!nexacro.BluetoothLE) {
	...
	_pBluetoothLE._onscanresult = function (objData) {
		if (nexacro._OS == "Windows") {
			...
			var e = new nexacro.BluetoothLEScanDeviceEventInfo("onscanresult", objDataParsed.devicename, objDataParsed.deviceaddress);
		}
		else {
	...
	_pBluetoothLE._onsubscriberesult = function (objData) {
		if (nexacro._OS == "Windows") {
			var objDataParsed = JSON.parse(objData);
			var e = new nexacro.BluetoothLEEventInfo(objDataParsed.eventid, objDataParsed.reason, objDataParsed.service_uuid, objDataParsed.message);
		}
		else {
	...
	_pBluetoothLE._onerror = function (objData) {
		if (nexacro._OS == "Windows") {
			var objDataParsed = JSON.parse(objData);
			var e = new nexacro.BluetoothLEErrorEventInfo(objDataParsed.eventid, objDataParsed.reason, objDataParsed.errormsg);
		}
		else {
